...
const bannerData = [
  {
    id: 1,
    title:
      "অনলাইন লার্নিং প্ল্যাটফর্মে স্বাগতম যেখানে আপনি যেকোনো জায়গা থেকে শিখতে পারেন",
    description:
  ...
  {
    id: 2,
    title: "নতুন কোর্স এখনি এনরোল করুন এবং আপনার জ্ঞান এবং দক্ষতা বাড়ান",
    description:
  ...
  },
  {
    id: 3,
    title:
      "আমাদের কমিউনিটিতে যোগ দিন যেখানে আপনি শিখবেন এবং একসাথে সমৃদ্ধ হবেন",
    description:
