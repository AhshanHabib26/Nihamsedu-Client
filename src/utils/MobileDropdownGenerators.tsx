...
const MobileDropdownGenerators: React.FC<DropdownProps> = ({ title, items }) => {
  ...
  return (
    <div className="relative inline-block text-left">
      ...
      <div
        className={`${Styles.MobileDropdownContainer} ${isOpen ? Styles.active : ""}`}
      >
        <div className="py-1">
...
export default MobileDropdownGenerators;
